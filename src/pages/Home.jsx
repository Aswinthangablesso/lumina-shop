...
import { Sparkles, ArrowRight, Star, ShieldCheck, Award, Zap, Quote } from 'lucide-react';

export const Home = () => {
  const [quickViewProduct, setQuickViewProduct] = useState(null);

  // Filter featured products (e.g. top 6)
      ...
      <section className="testimonials-section">
        <div className="container">
          <div className="section-title-center">
            ...
            <p className="section-subtitle">See what creators, engineers, and tech critics have to say about Lumina.</p>
          </div>
