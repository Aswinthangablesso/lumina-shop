  ...
  return (
    <footer className="footer-root">
        ...
        <div className="footer-main-grid">
          <div className="footer-brand-col">
            <Link to="/" className="brand-logo">
              ...
              <span className="logo-text">Lumina <span className="gradient-text">Shop</span></span>
            </Link>
      ...
      <style>{`
        ...
        .perk-title { font-size: 0.95rem; font-weight: 700; color: var(--text-primary); }
        .perk-desc { font-size: 0.8rem; color: var(--text-muted); }

        .footer-content { padding-top: 4rem; padding-bottom: 2rem; }
        .footer-main-grid {
          display: grid;
        ...
        .brand-tagline { margin: 1rem 0 1.5rem; font-size: 0.9rem; color: var(--text-muted); line-height: 1.6; }
        .newsletter-box {
          background: var(--surface);
          padding: 1.25rem;
        ...
        .newsletter-title { font-size: 0.95rem; font-weight: 700; color: var(--text-primary); }
        .newsletter-desc { font-size: 0.8rem; color: var(--text-muted); margin-bottom: 0.8rem; }
        ...
        .footer-heading { font-size: 1rem; font-weight: 700; color: var(--text-primary); margin-bottom: 1.2rem; }
        ...
        .heart-icon { color: #ef4444; display: inline; }
        .payment-badges { display: flex; align-items: center; gap: 0.5rem; }
        .payment-pill {
