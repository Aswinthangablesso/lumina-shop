  ...
  return (
    <div className="auth-page-root animate-fade-in">
      ...
      <style>{`
        ...
        .auth-title { font-size: 2rem; margin-bottom: 0.4rem; }
        ...
        .demo-badge { font-size: 0.7rem; font-weight: 700; color: var(--accent); }
        ...
        .input-icon { position: absolute; left: 0.85rem; color: var(--text-muted); }
        .input-with-icon .form-input { width: 100%; padding-left: 2.6rem; }
        .w-full { width: 100%; }
      `}</style>
    </div>
  );
