...
export const ProductsPage = () => {
  ...
  return (
    <div className="products-page-root animate-fade-in">
      ...
      <style>{`
        .products-page-root { padding: 2.5rem 0 4rem; }
        .page-header { margin-bottom: 2rem; display: flex; align-items: flex-end; justify-content: space-between; gap: 1.5rem; flex-wrap: wrap; }
        .page-title { font-size: 2.5rem; margin-bottom: 0.3rem; }
        .page-subtitle { color: var(--text-secondary); font-size: 1rem; }

        .catalog-meta-bar { display: flex; align-items: center; gap: 1rem; }
        .products-count-badge { font-size: 0.9rem; color: var(--text-muted); background: var(--surface); padding: 0.5rem 1rem; border-radius: var(--radius-full); border: 1px solid var(--border); }
        .mobile-filter-btn { display: none; }

        .catalog-workspace { display: grid; grid-template-columns: 280px 1fr; gap: 2rem; align-items: start; }

        .mobile-filter-modal { position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0, 0, 0, 0.75); z-index: 2500; display: flex; justify-content: flex-end; }
        .mobile-filter-content { width: 100%; max-width: 400px; height: 100%; background: var(--surface-card); overflow-y: auto; padding: 1.5rem; display: flex; flex-direction: column; gap: 1.5rem; }
        .mobile-filter-header { display: flex; align-items: center; justify-content: space-between; }
        .apply-mobile-btn { margin-top: 1rem; }
        .w-full { width: 100%; }

        @media (max-width: 900px) {
          .catalog-workspace { grid-template-columns: 1fr; }
          .desktop-sidebar-col { display: none; }
